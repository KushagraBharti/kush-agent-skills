...
- Do not edit the LaTeX preamble, custom commands, header/contact block, spacing commands, or link syntax. Preserve the current section structure and order: Education, Experience, Projects, Research, Technical Skills.
...
- Do not change the number of bullets for an entry by default. Rewrite bullets in place.
...
- Technical Skills should include all materially relevant supported posting keywords while preserving the existing categories and skills.
- Experience and Research section placement, order, titles, organizations, dates, locations, and links should be unchanged.
